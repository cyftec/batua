...
// ../dev/payment-methods.main.ts
var payment_methods_main_default = () => Page({
  title: "Batua | Payment Methods",
  headerTitle: "Add or modify payment methods",
  scriptSrcPrefix: "payment-methods.",
  selectedTabIndex: 4,
  content: m.Span({
