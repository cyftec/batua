...
// ../dev/expenses/@components/summary.ts
var Summary = Component(({ className, title, amount }) => {
  return m.Div({
...
// ../dev/expenses/@components/tile.ts
var Tile = Component(({ className, amount, title, date, tags, paymentMethod }) => {
  return m.Div({
    ...
    children: [
      ...
      m.Div({
        children: [
          ...
          m.Div({
            class: "mt1 f7 silver",
            children: m.Text(derived(() => date.value.toLocaleDateString(undefined, {
              weekday: "short",
              day: "numeric",
              month: "short"
            })))
